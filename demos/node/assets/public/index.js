...
let BcDatalogEditor = class BcDatalogEditor extends s {
    ...
    handleSelection(e) {
        ...
        const selected = value === null || value === void 0 ? void 0 : value.slice(selectionStart, selectionEnd);
    ...
    render() {
        ...
        const rendered = this.renderText(this.code, this._captures, this.marks, highlights);
...
${this.code}</textarea
    ...
    renderText(text, captures, marks, highlights) {
...
__decorate([
    t$1()
], BcDatalogEditor.prototype, "_selectedText", void 0);
...
let BcAuthorizerResult = class BcAuthorizerResult extends s {
    ...
    renderResult() {
        ...
        if (success) {
            ...
            return y `<div><pre>Public key parsing error</pre></div>`;
        }
        else if (parsingError) {
            return y `<div><pre>Token parsing error</pre></div>`;
        }
...
let BcTokenPrinter = class BcTokenPrinter extends s {
    ...
    renderAuthorizerResult(result) {
        if (this.biscuit === "") {
            return y `<div><pre>Please enter a base64-encoded token</pre></div>`;
        }
        if (this.rootPublicKey === "") {
            return y `<div><pre>Please enter a public key</pre></div>`;
        }
        return y `<bc-authorizer-result
      .content=${result}
    ></bc-authorizer-result>`;
    }
